// File name: monitor_3035449803.c
// Name: Zhou Zheng
// UID: 3035449803
// Development platform: Mac OS, tested on X2Go Linux Server @academy21
// Remark: I have completed all tasks. 
// Compile: Please use GNU99 standard to compile (default for clang). Note that the code cannot be compiled under c99. Using one of the following command to compile:
//          gcc -o monitor monitor_3035449803.c
//          gcc -o monitor -std=gnu99 monitor_3035449803.c
